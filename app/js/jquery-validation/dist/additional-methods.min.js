...
(function () {
    ...
    var b, c, d, e, f, g, h = ["A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "P", "R", "S", "T", "U", "V", "W", "X", "Y", "Z"],
        ...
        k = 0;
    for (b = 0; b < 17; b++) {
        e = j[b], d = a.slice(b, b + 1), b == 8 && (g = d);
        if (!isNaN(d)) d *= e;
        else
            for (c = 0; c < h.length; c++)
                if (d.toUpperCase() === h[c]) {
                    d = i[c], d *= e, isNaN(g) && c == 8 && (g = h[c]);
                    break
                }
        k += d
    }
    return f = k % 11, f == 10 && (f = "X"), f == g ? !0 : !1
    ...
    if (d.test(a)) {
        var e = a.split("/"),
            ...
            h = parseInt(e[2], 10),
            i = new Date(h, g - 1, f);
        i.getFullYear() == h && i.getMonth() == g - 1 && i.getDate() == f ? c = !0 : c = !1
    } else c = !1;
    ...
    return this.optional(b) ? !0 : (typeof c == "string" && (c = new RegExp("^(?:" + c + ")$")), c.test(a))
    ...
    var d = typeof c == "string" ? c.replace(/,/g, "|") : "image/*",
        e = this.optional(b),
        f, g;
    if (e) return e;
    if ($(b).attr("type") === "file") {
        ...
        if (b.files && b.files.length)
            for (f = 0; f < b.files.length; f++) {
                g = b.files[f];
                if (!g.type.match(new RegExp(".?(" + d + ")$", "i"))) return !1
            }
    }
    return !0
